# 🧠ChatGPT 中文调教指南
***Everloom-129 Reproduce 02/14/2023***

- fork 用作个人开发者对chatGPT使用体验的报告仓库
...
### [角色扮演卡](./role.md)
输入这些预设的角色卡，GPT就可以模拟各种各样好玩的功能。
而这是与模型训练相匹配的: 8 spare professional models within GPT-4 compete with each other, given correct role, it will enable those most related model, thus the performance will be enhanced. 
